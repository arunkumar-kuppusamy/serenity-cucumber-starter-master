...
For example a JUnit formatter:
    ...
    https://serenity-bdd.github.io/theserenitybook/0.1.0/extended-reports.html
    Now you can generate these reports by invoking the reports task:
    gradle reports

    https://github.com/serenity-bdd/serenity-banking-demo/blob/master/README.md
    https://johnfergusonsmart.com/whats-new-in-serenity-2/
    https://github.com/serenity-bdd/serenity-banking-demo/blob/master/src/test/resources/features/customer_acceptance_policy/business_activities.feature